...
sub new()
{
    ...
    read $INF, $sbufferSizeDB, 4 or die "fail to read buffersizeDB.\n";
    read $INF, $smaxBitrate, 4 or die "fail to read maxBitrate.\n";
    read $INF, $savgBitrate, 4 or die "fail to read avgBitrate.\n";
